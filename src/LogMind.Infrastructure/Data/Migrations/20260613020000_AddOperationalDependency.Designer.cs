...
namespace LogMind.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260613020000_AddOperationalDependency")]
    partial class AddOperationalDependency
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogMind.Core.Models.AiExplanationCache", b =>
                {
                    ...
                    b.HasIndex("MessageHash")
                        .IsUnique()
                        .HasDatabaseName("ix_cache_hash");

                    b.HasIndex("RelatedIssueId");

                    b.HasIndex("IsInvalidated", "LastUsedAt")
                        .HasDatabaseName("ix_cache_invalidated_lastused");

                    b.HasIndex("Source", "CreatedAt")
                        .HasDatabaseName("ix_cache_source_createdat");
            ...
            modelBuilder.Entity("LogMind.Core.Models.LogEntry", b =>
                {
                    ...
                    b.HasIndex("Source", "Level")
                        .HasDatabaseName("ix_logs_source_level");

                    b.HasIndex("Timestamp", "Id")
                        .HasDatabaseName("ix_logs_timestamp_id");
            ...
            modelBuilder.Entity("LogMind.Core.Models.OperationalDependency", b =>
                {
                    ...
                    b.HasIndex("SourceSystem")
                        .HasDatabaseName("ix_opdep_source");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("ix_opdep_active");
            ...
            modelBuilder.Entity("LogMind.Core.Models.OperationalKnowledge", b =>
                {
                    ...
                    b.Property<string>("ApplicableSources")
                        .IsRequired()
                        .HasDefaultValue("[]")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("IsActive")
                        .HasDatabaseName("ix_opknowledge_active");

                    b.HasIndex("Category")
                        .HasDatabaseName("ix_opknowledge_category");
            ...
            modelBuilder.Entity("LogMind.Core.Models.SolutionFeedback", b =>
                {
                    ...
                    b.HasIndex("LogEntryId")
                        .HasDatabaseName("ix_feedback_logentryid");

                    b.HasIndex("SolutionId")
                        .HasDatabaseName("ix_feedback_solutionid");
            ...
            modelBuilder.Entity("LogMind.Core.Models.AiExplanationCache", b =>
                {
                    ...
                    b.HasOne("LogMind.Core.Models.KnownIssue", "RelatedIssue")
                        .WithMany()
            ...
            modelBuilder.Entity("LogMind.Core.Models.SolutionFeedback", b =>
                {
                    ...
                    b.HasOne("LogMind.Core.Models.Solution", "Solution")
                        .WithMany("Feedback")
